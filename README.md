# Eidos websocket interface (eidosjs-ws)
...
```
<script type="text/javascript" src="https://cdn.rawgit.com/enumivo/eidosjs-ws/build/eidosjs-ws.js" />
```

A variable eidos_ws will be available in window.
